...
class QuizMedioScreen extends StatefulWidget {
  @override
  _QuizMedioScreenState createState() => _QuizMedioScreenState();
}

class _QuizMedioScreenState extends State<QuizMedioScreen> {
  List<Quiz> _quizzes = [];
  ...
  void _checkAnswer(String? selectedAnswer) {
    ...
    setState(() {
      ...
      if (_isCorrect) {
        _score += 150 + (_streak * 10); // Base score + streak bonus
        _streak++;
