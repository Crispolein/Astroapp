...
class PerfiladmingeiPage extends StatefulWidget {
  const PerfiladmingeiPage({super.key});

  @override
  PerfiladmingeiPageState createState() => PerfiladmingeiPageState();
}

class PerfiladmingeiPageState extends State<PerfiladmingeiPage> with TickerProviderStateMixin {
